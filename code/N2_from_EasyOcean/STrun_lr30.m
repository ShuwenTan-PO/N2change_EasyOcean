%
% sensitivity test, linear regression 30 m
%
clear all
close all
fl = 300; 
...
com = ['save ' gridded_file oceans{1} '/' sec '/' fname '_lr30.mat' ' D_pr ll_grid pr_grid pr_grid_lr'];
eval (com);
%     toc;
...
com = ['save ' gridded_file oceans{4} '/' sec '/' fname '_lr30.mat' ' D_pr ll_grid pr_grid pr_grid_lr'];
eval (com);
%     toc;

...
com = ['save ' gridded_file oceans{1} '/' sec '/' fname '_lr60.mat' ' D_pr ll_grid pr_grid pr_grid_lr'];
eval (com);
%     toc;
...
com = ['save ' gridded_file oceans{4} '/' sec '/' fname '_lr60.mat' ' D_pr ll_grid pr_grid pr_grid_lr'];
eval (com);
%     toc;
